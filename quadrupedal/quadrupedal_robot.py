...
if __name__ == "__main__":
    ...
    p.resetDebugVisualizerCamera(cameraDistance=1.5, cameraYaw=-30, cameraPitch=-30, cameraTargetPosition=[0.0, 0.2, 0.25])
    ...
    while(1):
        ...
        p.resetDebugVisualizerCamera(cameraDistance=1.5, cameraYaw=130, cameraPitch=-30, cameraTargetPosition=robotPosition)
        p.stepSimulation()
        time.sleep(1./200.)
